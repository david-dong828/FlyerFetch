...
class BiLSTMWithXLMRModel(nn.Module):
    ...
    def forward(self,input_ids, attention_mask):
        ...
        # for debug
        # print("category_logits: ", category_logits)
        # print("subcategory_logits: ", subcategory_logits)
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_loader:
            ...
            # Compute loss
            category_loss = torch.nn.CrossEntropyLoss(weight=category_class_weights_tensor)(category_probs, category_labels)
            subcategory_loss = torch.nn.CrossEntropyLoss(weight=subcategory_class_weights_tensor)(subcategory_probs, subcategory_labels)
